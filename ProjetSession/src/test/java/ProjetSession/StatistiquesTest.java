...
public class StatistiquesTest {
    private static Remboursement[] rembs = new Remboursement[3];
    private static Dossier dossier;
    private static int[] tabNbrSoins = new int[10];
    private static int[] tbMaxMonttSoins = new int[10];
    private static int[] tbTotMonttSoins = new int[10];
