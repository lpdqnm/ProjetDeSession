...
public class MensuelleTest {
    private static Mensuelle mens;
    private static Mensuelle osteo;
    private static Mensuelle med;
    private static Mensuelle psycho;
    private static Mensuelle chiro;
    private static Mensuelle physio;
    private static final int MAX_OSTEO = 25000;
    private static final int MAX_OSTEO_MOINS_DIX = 24000;
    private static final int MAX_MED = 20000;
    private static final int MAX_PSYCHO = 25000;
    private static final int MAX_CHIRO = 15000;
    private static final int MAX_PHYSIO = 30000;
