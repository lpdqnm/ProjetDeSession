...
public class DossierTest {
    ...
    Dossier dossierValideReclamInvalide;
    Dossier[] tabDossierInvalide_NumeroClient;
    Dossier[] tabDossierInvalide_Contrat;
    Dossier[] tabDossierInvalideReclam;    
    Reclamation[] tabReclamValide;
    Reclamation[] tabReclamInvalide;
    Reclamation[] tabReclamInvalide_NbSoinsJours;
    Remboursement[] tabRemboursementValide;
    ...
    public void setUp() {
        ...
        dossierValide = new Dossier("E100323","2017-01",tabReclamValide,tabRemboursementValide,null);
        
        tabDossierInvalide_NumeroClient = new Dossier[5];
        tabDossierInvalide_NumeroClient[0] = new Dossier("E10323","2017-01",tabReclamValide,null,null);
        tabDossierInvalide_NumeroClient[1] = new Dossier("E10032311","2017-01",tabReclamValide,null,null);
        tabDossierInvalide_NumeroClient[2] = new Dossier("E10032A","2017-01",tabReclamValide,null,null);
        tabDossierInvalide_NumeroClient[3] = new Dossier("EA00323","2017-01",tabReclamValide,null,null);
        tabDossierInvalide_NumeroClient[4] = new Dossier("E1003231A","2017-01",tabReclamValide,null,null);
                
        tabDossierInvalide_Contrat = new Dossier[2];
        tabDossierInvalide_Contrat[0] = new Dossier("Z100323","2017-01",tabReclamValide,null,null);
        tabDossierInvalide_Contrat[1] = new Dossier("1100323","2017-01",tabReclamValide,null,null);
       
        tabDossierInvalideReclam = new Dossier[1];
        tabDossierInvalideReclam[0] = new Dossier("E100323","2017-01",tabReclamInvalide_NbSoinsJours,null,null);
        
      
        dossierValideReclamInvalide = new Dossier("E100323","2017-01",tabReclamInvalide,null,null);
