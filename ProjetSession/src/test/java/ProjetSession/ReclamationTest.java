...
public class ReclamationTest {
    private static Reclamation reclamValide;
    private static Reclamation[] tabReclamInvalide_Soin;
    private static Reclamation[] tabReclamInvalide_Montant;
    private static Reclamation[] tabReclamInvalide_DateVsDemande;
    private static Reclamation[] tabReclamInvalide_DateFormat;
    private static Reclamation reclamInvalide_MaxMontant;
    private static Reclamation reclamInvalide_MinMontant;
    private static Reclamation reclamInvalide_Jour;
    private static final String DATE_TRAITEMENT = "2017-01";
    private static final String MONTANT_MAXIMUM_ERR = "500.01$";
    private static final String MONTANT_MINIMUM_ERR = "0.00$";
